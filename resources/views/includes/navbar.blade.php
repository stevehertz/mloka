<nav class="main-header navbar navbar-expand navbar-light bg-success">
    ...
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link" data-widget="pushmenu" href="#" role="button" style="color: #fff !important;">
                <i class="fas fa-bars"></i>
            </a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ route('dashboard', $shop->id) }}" class="nav-link" style="color: #fff !important;">
                Home
            </a>
        </li>
    </ul>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" data-toggle="dropdown" href="#" style="color: #fff !important;">
                ...
                {{ asset('storage/' . Auth::user()->profile) }} @endif"
                    alt="{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}" class="img-circle img-size-32 mr-2 elevation-2"> {{ Auth::user()->first_name }} {{ Auth::user()->last_name }}
            </a>
